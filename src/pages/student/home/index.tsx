    ...
    >
        ...
        <Card className={styles.welcomeCard}>
          <Row gutter={24} align="middle">
            ...
            <Col flex="1">
              ...
              >
                <Text>
                  <IdcardOutlined /> 学号：{basicInfo?.student_no}
                </Text>
                <Text>
                  <TeamOutlined /> {basicInfo?.class_name}
                </Text>
                <Text>
                  <PhoneOutlined /> {basicInfo?.phone}
                </Text>
                <Text>
                  <UserOutlined /> 导师：{basicInfo?.teacher}
                </Text>
              </div>
            </Col>
          </Row>
            ...
            <motion.div variants={itemVariants}>
              ...
              >
                ...
                <div className={styles.linkContent}>
                  <Title
                    level={5}
                    style={{ color: link.color, marginBottom: 8 }}
                  >
                    {link.title}
                  </Title>
      ...
      <motion.div variants={itemVariants} style={{ marginTop: 24 }}>
        ...
        >
          <Row gutter={[16, 16]}>
            {[
              { title: "毕业设计开题报告", time: "2024-12-01~2025-01-12" },
              { title: "毕业设计", time: "2025-01-13~2025-05-05" },
