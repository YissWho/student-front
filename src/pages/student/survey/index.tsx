...
import { Card, Typography, Tag, Empty, Spin, Result, Button, List, message } from 'antd';
                            ...
                            >
                                <div className={styles.cardContent}>
                                    <div className={styles.surveyInfo}>
                                        ...
                                        {survey.is_default && (
                                            <Tag color="gold">默认问卷</Tag>
                                        )}
                                    </div>

                                    <div className={styles.statusSection}>
                                        <div className={styles.tags}>
                                            <Tag color={survey.has_submitted ? '#87d068' : '#2db7f5'}
                                                icon={survey.has_submitted ? <CheckCircleOutlined /> : <ClockCircleOutlined />}>
