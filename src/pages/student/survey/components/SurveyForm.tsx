...
const SurveyForm: React.FC<SurveyFormProps> = ({ visible, surveyId, onCancel, onSuccess }) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Form.Item
                    noStyle
                    shouldUpdate={(prevValues, currentValues) => prevValues.future_plan !== currentValues.future_plan}
                >
                    {({ getFieldValue }) => {
                                ...
                                <>
                                    ...
                                    <motion.div {...formItemAnimation}>
                                        <Form.Item
                                            ...
                                            label="就业城市倾向"
                                            rules={[{ required: true, message: '请选择就业城市倾向' }]}
                                        >
                                            <Select placeholder="请选择">
                                    ...
                                    <motion.div {...formItemAnimation}>
                                        <Form.Item
                                            ...
                                            label="就业形势看法"
                                            rules={[{ required: true, message: '请选择就业形势看法' }]}
                                        >
                                            <Select placeholder="请选择">
