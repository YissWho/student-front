              ...
              <Col flex="auto">
                <Space direction="vertical" size={4}>
                  ...
                  <Space split={<Text type="secondary">|</Text>} size={20}>
                    <Text>
                      <PhoneOutlined /> {teacherInfo?.phone}
                    </Text>
                    <Text>
                      <TeamOutlined /> 共管理 {teacherInfo?.total_students}{" "}
                      名学生
                    </Text>
                    <Text>
                      <BookOutlined /> 管理 {teacherInfo?.classes?.length}{" "}
                      个班级
                    </Text>
                  </Space>
                </Space>
            ...
            <Col span={8}>
              <Card hoverable className={styles.statsCard}>
                <Statistic
                  ...
                  value={Math.round(
                    teacherInfo?.total_students / teacherInfo?.classes?.length
                  )}
                  ...
                  >
                    <Card.Meta
                      ...
                      description={
                        <Tag color="blue">
                          {Math.round(
                            (item.student_count / teacherInfo.total_students) *
                              100
                          )}
                          % 占比
                        </Tag>
