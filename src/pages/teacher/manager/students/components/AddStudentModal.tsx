...
import { Modal, Form, Input, Select, Upload, message, Space, Avatar, Steps } from 'antd';
import { UserOutlined, IdcardOutlined, PhoneOutlined, UploadOutlined, TeamOutlined, LoadingOutlined } from '@ant-design/icons';
