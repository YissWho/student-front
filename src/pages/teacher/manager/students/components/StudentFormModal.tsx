...
import { Modal, Form, Input, Select, Upload, message, Space, Avatar } from 'antd';
import { UserOutlined, IdcardOutlined, PhoneOutlined, UploadOutlined } from '@ant-design/icons';
